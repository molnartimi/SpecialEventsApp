...
import hu.molti.specialevents.listener.EventSpinnerOnSelectedListener;
import hu.molti.specialevents.listener.MonthSpinnerOnSelectedListener;
                ...
                .setPositiveButton(R.string.save_something, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (event == null) {
                            ...
                            eventService.update(getEvent(), originMonth);
                        }
